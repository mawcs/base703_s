...
/*****************************************************************
 * URL.js
 * MIT licensed - https://github.com/websanova/js-url
 */
window.url = (function() {
...
$(function(){
    ...
    var thanks = window.url("?thanks");

    if ((thanks === "true") || (thanks === true)){
        $(".newsletter-form").html("<h3>Thank you for subscribing.</h3>");
    }
